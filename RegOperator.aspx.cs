...
public partial class Admin_RegOperator : System.Web.UI.Page
{
    ...
    {
        dc.User_Insert(2, txtFname.Text, txtLname.Text, txtAddress.Text, txtCntn.Text, int.Parse(txtPcode.Text), txtUname.Text, txtPwd.Text, txtEmailId.Text, Convert.ToDateTime(txtDOB.Text), FuImage.FileName, int.Parse(ddlArea.SelectedValue),true);

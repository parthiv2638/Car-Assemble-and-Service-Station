<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminProfile.aspx.cs" Inherits="Admin_AdminProfile" %>
    ...
    <form id="frm" runat="server">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner container">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="../Images/new logo.jpg" style="padding-bottom" alt="logo" class="" />
                    </a>
                ...
                <div class="page-top">
                    ...
                    <div class="search-form search-form-expanded" action="extra_search.html" method="GET">
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="../Images/IMG_20150117_201930.JPG" />
                                    <span class="username username-hide-on-mobile">Parthiv </span>
        ...
        <div class="container">
            ...
            <div class="page-container">
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
						...
						<ul class="sub-menu">
                            ...
                            <li>
                                <a href="VehicleTypeProductList.aspx">
                                    <i class="icon-puzzle"></i>
                                    <span class="title">Vehicle Type Products</span>
                                    <span class="arrow "></span>
                                </a>
                                <%--<ul class="sub-menu">
							<li>
					...
					<li class="tooltips" data-container="body" data-placement="right" data-html="true" data-original-title="AngularJS version demo">
						...
						Worker Reg </span>
                            ...
                            <li>
                                <a href="javascript:;">
                                    <i class="icon-user"></i>
                                    <span class="title">Registarion</span>
                                    <span class="arrow "></span>
                                </a>
                                <ul class="sub-menu">
                                    <li>
                                        <a href="RegOperator.aspx">Operator Reg</a>
                                    </li>
                                    <li>
                                        <a href="RegWorkers.aspx">Worker Reg</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="OperatorList.aspx">Operator Authenticate</a>
                                    </li>
                                    <li>
                                        <a href="WorkersList.aspx">Worker Authenticate</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="AProfile.aspx">
                ...
                <div class="page-content-wrapper">
                    <div class="page-content">
                        ...
                        <!-- BEGIN PAGE HEADER-->
                        <h3 class="page-title">User Account <small></small>
                        </h3>
                        <div class="page-bar">
                                ...
                                <div class="profile-sidebar" style="width: 250px;">
                                    ...
                                    <div class="portlet light profile-sidebar-portlet">
                                        ...
                                        <div class="profile-userpic">
                                            <img src="../Images/IMG_20150117_201930.JPG" class="img-responsive" alt="">
                                        </div>
                                        <!-- END SIDEBAR USERPIC -->
                                        <!-- SIDEBAR USER TITLE -->
                                        ...
                                        <div class="profile-userbuttons">
                                            <a href="AdminHome.aspx" ><button type="button" class="btn btn-circle green-haze btn-sm">Home</button></a>
                                            <a href="ALogout.aspx"><button type="button" class="btn btn-circle btn-danger btn-sm">Log Out</button></a>
                                        </div>
                                        <!-- END SIDEBAR BUTTONS -->
                                        <!-- SIDEBAR MENU -->
            ...
            <div class="page-footer">
                <div class="page-footer-inner">
                    2014 &copy; Car Assemble And Service Station.
                </div>

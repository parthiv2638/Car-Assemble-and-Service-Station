...
<body class="login">
    <form id="frm" runat="server">
            ...
            <div class="login-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <asp:TextBox ID="txtUname" runat="server" class="form-control placeholder-no-fix" placeholder="Username"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <asp:TextBox ID="txtPwd" TextMode="Password" runat="server" class="form-control placeholder-no-fix" placeholder="Password"></asp:TextBox>
                    </div>
                </div>
                <div class="form-actions">
                    ...
                    <asp:Button ID="btnLogin" runat="server" Text="Submit" class="btn green-haze pull-right" OnClick="btnLogin_Click" />
                </div>
                 <asp:Label ID="lblMsg" runat="server" Text=""></asp:Label>
            ...
            <div class="forget-form" action="index.html" method="post">
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <asp:TextBox ID="txtEmail" class="form-control placeholder-no-fix" autocomplete="off" placeholder="Email" name="email"  runat="server"></asp:TextBox>
                    </div>
                </div>
                <div class="form-actions">
                    ...
                    <asp:Button ID="btnSubmit" class="btn green-haze pull-right" runat="server" OnClick="btnSubmit_Click" Text="Submit" />
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
            2015 &copy; Car Assemble And Service Station. Admin.
        </div>
        <!-- END COPYRIGHT -->

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AMasterPage.master" AutoEventWireup="true" CodeFile="RegOperator.aspx.cs" Inherits="Admin_RegOperator" %>
        ...
        <div class="col-md-12 ">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Operator Registration Form
                    </div>
                    <div class="tools">

...
public partial class Admin_OperatorList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var data = (from t in dc.Users where t.Did.Equals(2) select t).ToList();
        ...
        foreach (var item in data)
        {
            ...
            str += "<tr><td><a href=OperatorEdit.aspx?Id=" + item.Userid + ">Edit</a></td><td>" + item.Username + "</td><td>" + item.Address +"</td><td>" +item.Contno + "</td><td>" + item.Email + "</td><td> <img src='../Images/" + item.Userimg + "' height ='100px' width ='100px' /></td><td>" + s + "</td></tr>";
        }
        str += "</table>";
        dis.InnerHtml = str;
    }
